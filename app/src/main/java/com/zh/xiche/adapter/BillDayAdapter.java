...
public class BillDayAdapter extends BaseAdapter {
    ...
    public BillDayAdapter(Context context, List<BillDetailEntity> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.daybill_list_item, parent, false);
            holder = new ViewHolder();
            holder.iconImg = (ImageView) convertView.findViewById(R.id.daybill_list_item_icon_img);
            holder.nameTv = (TextView) convertView.findViewById(R.id.daybill_list_item_name_tv);
            holder.phoneTv = (TextView) convertView.findViewById(R.id.daybill_list_item_phone_tv);
            holder.phoneBtn = (ImageView) convertView.findViewById(R.id.daybill_list_item_phone_img);
            holder.orderTv = (TextView) convertView.findViewById(R.id.daybill_list_item_order_tv);
            holder.typeTv = (TextView) convertView.findViewById(R.id.daybill_list_item_type_tv);
            holder.addTv = (TextView) convertView.findViewById(R.id.daybill_list_item_add_tv);
            holder.timeTv = (TextView) convertView.findViewById(R.id.daybill_list_item_time_tv);
            holder.carTypeTv = (TextView) convertView.findViewById(R.id.daybill_list_item_cartype_tv);
            holder.colorTv = (TextView) convertView.findViewById(R.id.daybill_list_item_color_tv);
            holder.numTv = (TextView) convertView.findViewById(R.id.daybill_list_item_num_tv);
            holder.priceTv = (TextView) convertView.findViewById(R.id.daybill_list_item_price_tv);
            holder.dateTv = (TextView) convertView.findViewById(R.id.daybill_list_item_date_tv);
            holder.dateDesTv = (TextView) convertView.findViewById(R.id.daybill_list_item_datedes_tv);
            holder.remarkTv = (TextView) convertView.findViewById(R.id.daybill_list_item_remark_tv);
        ...
        final BillDetailEntity entity = list.get(position);
        //头像
