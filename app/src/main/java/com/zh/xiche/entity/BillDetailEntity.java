...
public class BillDetailEntity implements Parcelable {
    ...
    protected BillDetailEntity(Parcel in) {
    ...
    public static final Creator<BillDetailEntity> CREATOR = new Creator<BillDetailEntity>() {
        @Override
        public BillDetailEntity createFromParcel(Parcel source) {
            return new BillDetailEntity(source);
        }

        @Override
        public BillDetailEntity[] newArray(int size) {
            return new BillDetailEntity[size];
        }
    };
}
